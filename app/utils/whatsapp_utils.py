...
llm = ChatOpenAI(api_key="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",model="gpt-4-1106-preview")
openai_client=OpenAI(api_key='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')
